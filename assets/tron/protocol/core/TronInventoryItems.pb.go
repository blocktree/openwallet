...
func (*InventoryItems) Descriptor() ([]byte, []int) {
	return fileDescriptor_TronInventoryItems_99d3fb2b2881ea1c, []int{0}
}
...
func init() {
	proto.RegisterFile("TronInventoryItems.proto", fileDescriptor_TronInventoryItems_99d3fb2b2881ea1c)
}

var fileDescriptor_TronInventoryItems_99d3fb2b2881ea1c = []byte{
