...
// MsgInv implements the Message interface and represents a hcd inv message.
...
// NewMsgInv returns a new hcd inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new hcd inv message that conforms to the
