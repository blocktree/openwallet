...
const DefaultUserAgent = "/hcwire:0.3.0/"

// MsgVersion implements the Message interface and represents a hcd version
...
// NewMsgVersion returns a new hcd version message that conforms to the
...
// and local address from conn and returns a new hcd version message that
