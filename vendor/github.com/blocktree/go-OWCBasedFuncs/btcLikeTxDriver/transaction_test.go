...
func Test_case1(t *testing.T) {
	...
	unlockData1 := TxUnlock{nil, in1Lock, "", uint64(0)}
	unlockData2 := TxUnlock{nil, in2Lock, "", uint64(0)}
...
func Test_case2(t *testing.T) {
	...
	unlockData1 := TxUnlock{nil, in1Lock, in1Redeem, in1Amount}
	unlockData2 := TxUnlock{nil, in2Lock, in2Redeem, in2Amount}
