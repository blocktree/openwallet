...
var (
	//BTC stuff
	BTC_mainnetAddressP2PKH         = AddressType{"base58", btcAlphabet, "doubleSHA256", 20, []byte{0x00}, nil}
	BTC_mainnetAddressP2SH          = AddressType{"base58", btcAlphabet, "doubleSHA256", 20, []byte{0x05}, nil}
	...
	BTC_testnetAddressP2PKH         = AddressType{"base58", btcAlphabet, "doubleSHA256", 20, []byte{0x6F}, nil}
	BTC_testnetAddressP2SH          = AddressType{"base58", btcAlphabet, "doubleSHA256", 20, []byte{0xC4}, nil}
	...
	//LTC stuff
	LTC_mainnetAddressP2PKH         = AddressType{"base58", ltcAlphabet, "doubleSHA256", 20, []byte{0x30}, nil}
	LTC_mainnetAddressP2SH          = AddressType{"base58", ltcAlphabet, "doubleSHA256", 20, []byte{0x05}, nil}
	...
	LTC_testnetAddressP2PKH         = AddressType{"base58", ltcAlphabet, "doubleSHA256", 20, []byte{0x6F}, nil}
	LTC_testnetAddressP2SH          = AddressType{"base58", ltcAlphabet, "doubleSHA256", 20, []byte{0xC4}, nil}
	...
	//BCH stuff
	BCH_mainnetAddressLegacy = AddressType{"base58", bchLegacyAlphabet, "doubleSHA256", 20, []byte{0x00}, nil}
	BCH_mainnetAddressCash   = AddressType{"base32PolyMod", bchCashAlphabet, "bitcoincash", 21, nil, nil}

	//XTZ stuff
	XTZ_mainnetAddress_tz1   = AddressType{"base58", xtzAlphabet, "doubleSHA256", 20, []byte{0x06, 0xA1, 0x9F}, nil}
	XTZ_mainnetAddress_tz2   = AddressType{"base58", xtzAlphabet, "doubleSHA256", 20, []byte{0x06, 0xA1, 0xA1}, nil}
	XTZ_mainnetAddress_tz3   = AddressType{"base58", xtzAlphabet, "doubleSHA256", 20, []byte{0x06, 0xA1, 0xA4}, nil}
	...
	XTZ_mainnetPrivate_p2sk  = AddressType{"base58", xtzAlphabet, "doubleSHA256", 32, []byte{0x10, 0x51, 0xEE, 0xBD}, nil}

	//HC stuff
	HC_mainnetPublicAddress = AddressType{"base58", hcAlphabet, "doubleBlake256", 20, []byte{0x09, 0x7F}, nil}

	//QTUM stuff
	QTUM_mainnetAddressP2PKH         = AddressType{"base58", qtumAlphabet, "doubleSHA256", 20, []byte{0x3A}, nil}
	QTUM_mainnetAddressP2SH          = AddressType{"base58", qtumAlphabet, "doubleSHA256", 20, []byte{0x32}, nil}
	...
	QTUM_testnetAddressP2PKH         = AddressType{"base58", qtumAlphabet, "doubleSHA256", 20, []byte{0x78}, nil}
	QTUM_testnetAddressP2SH          = AddressType{"base58", qtumAlphabet, "doubleSHA256", 20, []byte{0x6E}, nil}
